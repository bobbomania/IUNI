...
public class Parser 
{
    ...
    public Command getCommand() 
    {
        ...
        //make the word match the closest command word
        word1 = commands.normalizeCommandWord(word1);
    ...
    /**
     * Returns the help description of the command specified
     * @param command the command that we need the description of
     */
    public void helpCommand(String command){
        command = commands.normalizeCommandWord(command);
